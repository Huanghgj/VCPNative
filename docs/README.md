...
- `android-code-audit-2026-04-05.md`
  2026-04-05 仓库级代码审查记录，覆盖同步、Notes IPC、浏览器 HTML 渲染、技能链路和语音聊天保存链路。

- `android-chat-ui-audit-2026-04-10.md`
  2026-04-10 聊天页面 UI 审查记录，聚焦顶部栏、输入区、头像菜单、长按菜单、图片查看器和 WebView 内按钮行为。

- `android-chat-performance-audit-2026-04-10.md`
  2026-04-10 聊天页面性能审查记录，聚焦流式渲染、消息/附件匹配、WebView 同步、Room 更新和 compat 历史落盘成本。
